 ...
 * @public
 */
export interface HierarchicalFacetCustomCssClasses
  extends HierarchicalFacetDisplayCssClasses {
...
export interface HierarchicalFacetProps
  extends Omit<StandardFacetProps, "transformOptions" | "showOptionCounts"> {
  /**
