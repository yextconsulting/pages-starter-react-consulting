...
const CoreHeading = (props: {children: React.ReactNode}) => {
  return <h2 className="Heading--sub mb-4">{props.children}</h2>
}
      ...
      <div className="container">
        <div className="flex flex-row flex-wrap">
          <CoreSection>
            ...
            <Link className="Link--primary Link--underline font-bold mt-2" href={`${getDirections(profile.address, profile.ref_listings, profile.googlePlaceId)}`}>Get Directions</Link>
