            ...
            <div className="Core-container centered-container">
                <div className="Core-infoSection">
                    <div className="Core-subSection mb-8">
                        ...
                        <Link className="Core-directionsCta Link--primary Link--underline font-bold mt-2" href={`${getDirections(props.profile, GoogleMaps)}`}> Get Directions </Link>
                        {mainPhone && (
                        ...
                        {emails && (
                            <Link className="Core-email Link--primary Link--underline font-bold mt-4" href={`mailto:${emails[0]}`}>{emails[0]}</Link>
                        )}
                    </div>
                {(hours || additionalHoursText) && (
                    <div className="Core-subSection mb-8">
                        ...
                        {hours && (
                            <HoursTable hours={hours} startOfWeek={"Monday"} />
                        )}
                        {additionalHoursText && (
                ...
                <LocationMap clientKey={'gme-yextinc'} coordinate={geocodedCoordinate} provider={GoogleMaps}>
